...
public class Updater {
    ...
    public Updater(Plugin plugin, String slug, File file, UpdateType type, boolean announce) {
        ...
        (new UpdateRunnable()).runTaskTimerAsynchronously(plugin, 20, 216000L);
        /*
         * thread = new Thread(new UpdateRunnable()); thread.start();
         */
    }
                ...
                if (readFeed()) {
                    if (versionCheck(versionTitle)) {
                        ...
                        if (fileLink != null && type != UpdateType.NO_DOWNLOAD) {
                            ...
                            ;
                            BukkitRunnable reloader = new BukkitRunnable() {
